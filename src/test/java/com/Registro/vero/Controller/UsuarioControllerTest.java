...
public class UsuarioControllerTest {
    ...
    void crearUsuario_RetornaUsuario() {
        ...
        UsuarioRegistroDTO esperado = new UsuarioRegistroDTO(1L, "Ana", "Lopez", "Gomez", "12345678-9", "ana@gmail.com", LocalDate.now(), "ADMIN", Set.of("USUARIO"));
    ...
    void obtenerUsuario_RetornaUsuario() {
        UsuarioRegistroDTO dto = new UsuarioRegistroDTO(1L, "Ana", "Lopez", "Gomez", "123", "ana@gmail.com", LocalDate.now(), "ADMIN", Set.of());
    ...
    void actualizarUsuario_RetornaActualizado() {
        ...
        UsuarioRegistroDTO actualizado = new UsuarioRegistroDTO(1L, "Ana", "Actualizado", "Gomez", "123", "ana@gmail.com", LocalDate.now(), "ADMIN", Set.of());
